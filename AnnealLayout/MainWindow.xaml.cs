...
namespace MindFusion.Diagramming.Wpf.Samples.CS.AnnealLayout
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            iterationTxB.Text = layout.IterationsPerStage.ToString();
            stageTxB.Text = layout.Stages.ToString();
            initialTxB.Text = layout.InitialTemperature.ToString();
            tempScaleTxB.Text = layout.TemperatureScale.ToString();

            linkLengthFactorTxB.Text = layout.LinkLengthFactor.ToString();
            crossingArrowsCostTxB.Text = layout.CrossingLinksCost.ToString();
            distributionFactorTxB.Text = layout.DistributionFactor.ToString();
            nodeArrowDistFactorTxB.Text = layout.NodeLinkDistFactor.ToString();
            boundaryFactorTxB.Text = layout.BoundaryFactor.ToString();
